...
function CategoryGlyph({ kind }: { kind: 'plumbing' | 'electrical' | 'walls' | 'appliances' }) {
  const size = 46;
      ...
      >
        ...
        <View style={styles.grid}>
          {(
            ...
            <NoirCard key={tile.kind} variant="default" radius="md" padding={18} style={styles.tile}>
        ...
        <View style={styles.samples}>
          ...
          <View style={styles.samplesRow}>
            {(
              ...
              <NoirCard key={s.tag} variant="outlined" radius="md" padding={12} style={styles.sampleCard}>
        ...
        <View style={styles.anchor}>
          ...
          <Pressable
            ...
            accessibilityLabel="See a sample estimate instead"
