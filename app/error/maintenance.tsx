...
function WrenchClockGlyph({ size = 72, color = colors.cyan }: { size?: number; color?: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 72 72">
      {/* wrench on left */}
      <Path
        d="M30 14a8 8 0 00-6.4 12.8L10 40.4 13.6 44 27.2 30.4A8 8 0 1030 14z"
        stroke={color}
        strokeWidth={1.8}
        fill="none"
      ...
      >
        ...
        <View style={styles.ctaWrap}>
          <AmberCTA
            ...
            fullWidth
            onPress={checkAgain}
            accessibilityLabel="Check if maintenance is complete"
          />
          ...
          <Pressable
            ...
            accessibilityLabel="Open status updates on Twitter"
