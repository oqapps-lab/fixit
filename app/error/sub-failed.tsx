...
function CardXGlyph({ size = 56, color = colors.danger }: { size?: number; color?: string }) {
  return (
...
export default function SubFailed() {
  ...
  return (
    <Pressable style={styles.backdrop} onPress={close} accessibilityLabel="Close payment error">
      ...
      >
        ...
        <View style={styles.ctaStack}>
          <AmberCTA
            ...
            size="lg"
            onPress={retry}
            accessibilityLabel="Try the payment again"
          />
          <AmberCTA
            label="Use different card"
            variant="outlined"
            size="lg"
            onPress={differentCard}
