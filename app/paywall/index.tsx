...
function CheckMark({ size = 12, color = colors.mint }: { size?: number; color?: string }) {
  return (
...
function CloseGlyph({ size = 18, color = colors.text }: { size?: number; color?: string }) {
  return (
...
export default function SoftPaywall() {
  ...
  const primaryLabel =
    plan === 'annual' ? 'Start annual — $49.99' : 'Start monthly — $9.99';
      ...
      >
        ...
        <View style={styles.plans}>
          <Pressable
            ...
            accessibilityLabel="Annual plan, $49.99 per year, best value"
        ...
        <View style={styles.ctaWrap}>
          <AmberCTA
            ...
            accessibilityLabel={`Subscribe: ${primaryLabel}`}
          />
        </View>
        ...
        <View style={styles.payOnceRow}>
          ...
          <AmberCTA
            ...
            size="sm"
            fullWidth={false}
            onPress={handlePayOnce}
            accessibilityLabel="Pay $2.99 for a single estimate"
          />
        </View>
        ...
        <Pressable
          ...
          hitSlop={8}
          accessibilityRole="button"
          accessibilityLabel="Dismiss paywall and return home"
