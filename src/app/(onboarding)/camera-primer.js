    ...
    return (<NoirScreen>
      ...
      <View style={[
        ...
        <View style={styles.anchor}>
          <AmberCTA label="Allow camera" variant="primary" size="lg" icon={<CameraGlyph size={18} color={colors.textOnAmber}/>} onPress={() => router.push('/(onboarding)/capture')}/>
          <Pressable onPress={() => router.push('/(onboarding)/capture')} hitSlop={8} accessibilityRole="button" accessibilityLabel="Upload a saved photo instead">
