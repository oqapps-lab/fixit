...
export default function RepairsTab() {
    ...
    return (<NoirScreen>
      ...
      <ScrollView contentContainerStyle={[
        ...
        <AmberCTA label="+ New Estimate" variant="primary" size="md" onPress={() => router.push('/your-house')} style={{ marginTop: spacing.lg }}/>
        ...
        <View style={{ marginTop: spacing.md, gap: spacing.md }}>
          {ACTIVE_REPAIRS.map((r) => (<Pressable key={r.id} onPress={() => router.push(`/repair/${r.id}`)} accessibilityRole="button" accessibilityLabel={`${r.title} — open details`}>
        ...
        <View style={{ marginTop: spacing.md, gap: spacing.sm }}>
          {PAST_REPAIRS.map((r) => (<NoirCard key={r.id} variant="outlined" radius="md" padding={16}>
