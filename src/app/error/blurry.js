...
function FocusTargetGlyph({ size = 56, color = colors.amber }) {
...
export default function Blurry() {
    ...
    return (<Pressable style={styles.backdrop} onPress={close} accessibilityLabel="Close blurry photo error">
      ...
      <Pressable onPress={(e) => e.stopPropagation()} style={[styles.sheet, { paddingBottom: insets.bottom + spacing.xxl }]}>
        ...
        <View style={styles.ctaStack}>
          ...
          <AmberCTA label="Use it anyway" variant="outlined" size="lg" onPress={useAnyway} accessibilityLabel="Use the blurry photo anyway"/>
        </View>
      </Pressable>
    </Pressable>);
}
