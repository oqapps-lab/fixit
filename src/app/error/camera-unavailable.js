...
export default function CameraUnavailable() {
    ...
    return (<Pressable style={styles.backdrop} onPress={close} accessibilityLabel="Close camera error">
      ...
      <Pressable onPress={(e) => e.stopPropagation()} style={[styles.sheet, { paddingBottom: insets.bottom + spacing.xxl }]}>
        ...
        <View style={styles.ctaStack}>
          ...
          <AmberCTA label="Use gallery instead" variant="outlined" size="lg" onPress={useGallery} accessibilityLabel="Pick a photo from your gallery"/>
        </View>

        <Pressable onPress={close} hitSlop={8} accessibilityRole="button" accessibilityLabel="Describe with text" style={styles.tertiaryWrap}>
