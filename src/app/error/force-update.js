...
function DownloadArrowGlyph({ size = 72, color = colors.amber }) {
    return (<Svg width={size} height={size} viewBox="0 0 72 72">
      ...
      {/* arrow head */}
      <Polyline points="22,34 36,48 50,34" stroke={color} strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      {/* landing tray */}
    ...
    return (<NoirScreen glow="amber">
      <View style={[
        ...
        <View style={styles.ctaWrap}>
          <AmberCTA label="Open App Store" variant="primary" size="xl" fullWidth onPress={openStore} accessibilityLabel="Open the App Store to update FixIt"/>
