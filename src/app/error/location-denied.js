...
function PinSlashGlyph({ size = 56, color = colors.amber }) {
    return (<Svg width={size} height={size} viewBox="0 0 56 56">
      <Path d="M28 48s14-14 14-26a14 14 0 10-28 0c0 12 14 26 14 26z" stroke={color} strokeWidth={1.6} fill="none" strokeLinejoin="round"/>
...
export default function LocationDenied() {
    ...
    return (<Pressable style={styles.backdrop} onPress={close} accessibilityLabel="Close location error">
      ...
      <Pressable onPress={(e) => e.stopPropagation()} style={[styles.sheet, { paddingBottom: insets.bottom + spacing.xxl }]}>
        ...
        <View style={styles.ctaStack}>
          <AmberCTA label="Enter ZIP manually" variant="primary" size="lg" onPress={enterZip} accessibilityLabel="Enter ZIP code manually"/>
          <AmberCTA label="Open Settings" variant="outlined" size="lg" onPress={openSettings} accessibilityLabel="Open iOS Settings to enable location"/>
        </View>
      </Pressable>
    </Pressable>);
}
