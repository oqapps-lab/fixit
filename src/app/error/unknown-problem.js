...
function QuestionCircleGlyph({ size = 56, color = colors.amber }) {
    return (<Svg width={size} height={size} viewBox="0 0 56 56">
      <Circle cx={28} cy={28} r={22} stroke={color} strokeWidth={1.6} fill="none"/>
      <Path d="M22 22a6 6 0 1112 0c0 3-3 4-5 5-1 1-1 2-1 4" stroke={color} strokeWidth={1.8} fill="none" strokeLinecap="round" strokeLinejoin="round"/>
...
export default function UnknownProblem() {
    ...
    return (<Pressable style={styles.backdrop} onPress={close} accessibilityLabel="Close unknown problem error">
      ...
      <Pressable onPress={(e) => e.stopPropagation()} style={[styles.sheet, { paddingBottom: insets.bottom + spacing.xxl }]}>
        ...
        <View style={styles.ctaStack}>
          <AmberCTA label="Retake photo" variant="primary" size="lg" onPress={retake} accessibilityLabel="Retake the photo"/>
          <AmberCTA label="Describe in text" variant="outlined" size="lg" onPress={describeText} accessibilityLabel="Describe the problem in text"/>
        </View>

        <Pressable onPress={browseCommon} hitSlop={8} accessibilityRole="button" accessibilityLabel="Browse common repairs" style={styles.tertiaryWrap}>
