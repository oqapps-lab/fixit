...
function BookmarkGlyph({ size = 36, color = colors.amber }) {
    return (<Svg width={size} height={size} viewBox="0 0 36 36">
      <Path d="M10 6 h16 v24 l-8 -6 l-8 6 z" stroke={color} strokeWidth={1.6} fill={color} fillOpacity={0.16} strokeLinejoin="round"/>
    </Svg>);
}
