    ...
    return (<NoirScreen>
      ...
      <ScrollView contentContainerStyle={[
        ...
        <View style={{ marginTop: spacing.md, gap: spacing.sm }}>
          {TASKS.map((t, i) => (<NoirCard key={t.id} variant="default" radius="md" padding={16}>
        ...
        <AmberCTA label="Start Checklist" variant="primary" onPress={() => { }} style={{ marginTop: spacing.xxl }}/>
      </ScrollView>
    </NoirScreen>);
}
