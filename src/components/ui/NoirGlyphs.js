...
import Svg, { Circle, Defs, G, Line, LinearGradient as SvgLinearGradient, Path, Polyline, Rect, Stop, } from 'react-native-svg';
import { colors } from '@/constants/tokens';
export function ChevronLeftGlyph({ size = 20, color = '#F5F5F7', strokeWidth = 1.6 }) {
    return (<Svg width={size} height={size} viewBox="0 0 20 20">
      <Polyline points="12,4 5,10 12,16" stroke={color} strokeWidth={strokeWidth} fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </Svg>);
}
export function ChevronRightGlyph({ size = 16, color = '#A8A8AD', strokeWidth = 1.4 }) {
    return (<Svg width={size} height={size} viewBox="0 0 16 16">
      <Polyline points="6,3 11,8 6,13" stroke={color} strokeWidth={strokeWidth} fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </Svg>);
}
export function MenuGlyph({ size = 20, color = '#F5F5F7' }) {
    return (<Svg width={size} height={size} viewBox="0 0 20 20">
...
export function AvatarCircle({ size = 28 }) {
    return (<View style={{
            width: size,
            height: size,
            borderRadius: size / 2,
      ...
      <Svg width={size * 0.6} height={size * 0.6} viewBox="0 0 20 20">
        ...
        <Path d="M3.5 17c1-3 3.5-4.5 6.5-4.5s5.5 1.5 6.5 4.5" stroke={colors.textSecondary} strokeWidth={1.2} fill="none" strokeLinecap="round"/>
      </Svg>
    </View>);
}
export function GearGlyph({ size = 18, color = '#A8A8AD' }) {
...
export function BellGlyph({ size = 18, color = '#A8A8AD' }) {
    return (<Svg width={size} height={size} viewBox="0 0 18 18">
      <Path d="M9 2v1M4 14V9a5 5 0 0110 0v5l1 1.5H3L4 14zM7 16a2 2 0 004 0" stroke={color} strokeWidth={1.3} fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </Svg>);
}
export function HomeGlyph({ size = 22, color = '#F5F5F7', filled }) {
    return (<Svg width={size} height={size} viewBox="0 0 22 22">
      <Path d="M3 11l8-7 8 7v9H3v-9z" fill={filled ? color : 'none'} fillOpacity={filled ? 0.18 : 0} stroke={color} strokeWidth={1.4} strokeLinejoin="round"/>
      <Rect x={9} y={13} width={4} height={7} stroke={color} strokeWidth={1.2} fill="none"/>
    </Svg>);
}
export function WrenchGlyph({ size = 22, color = '#F5F5F7', filled }) {
    return (<Svg width={size} height={size} viewBox="0 0 22 22">
      <Path d="M15 3a4 4 0 00-3.2 6.4L3 18.2l1.8 1.8L14 10.2A4 4 0 1015 3z" fill={filled ? color : 'none'} fillOpacity={filled ? 0.2 : 0} stroke={color} strokeWidth={1.4} strokeLinejoin="round"/>
    </Svg>);
}
export function ClockGlyph({ size = 22, color = '#F5F5F7', filled }) {
    return (<Svg width={size} height={size} viewBox="0 0 22 22">
...
export function CheckGlyph({ size = 18, color = '#6BDE9A', strokeWidth = 1.8 }) {
    return (<Svg width={size} height={size} viewBox="0 0 18 18">
      <Polyline points="3.5,9.5 7.5,13.5 14.5,5.5" stroke={color} strokeWidth={strokeWidth} fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </Svg>);
}
export function VaultGlyph({ size = 22, color = '#F5F5F7', filled }) {
    return (<Svg width={size} height={size} viewBox="0 0 22 22">
...
export function PinGlyph({ size = 18, color = '#6BCBD9' }) {
    return (<Svg width={size} height={size} viewBox="0 0 18 18">
      <Path d="M9 16s5-5 5-9a5 5 0 10-10 0c0 4 5 9 5 9z" fill={color} fillOpacity={0.18} stroke={color} strokeWidth={1.2}/>
      <Circle cx={9} cy={7} r={1.8} fill={color}/>
    </Svg>);
}
export function ArrowUpRightGlyph({ size = 14, color = '#A8A8AD' }) {
...
export function RescanGlyph({ size = 14, color = '#6BCBD9' }) {
    return (<Svg width={size} height={size} viewBox="0 0 14 14">
      <Path d="M12 7a5 5 0 11-1.5-3.6M12 3v2.5h-2.5" stroke={color} strokeWidth={1.4} fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </Svg>);
}
export function CameraGlyph({ size = 18, color = '#F5F5F7' }) {
    return (<Svg width={size} height={size} viewBox="0 0 18 18">
 ...
 */
export function HouseWireframe({ size = 240, withGrid = true, }) {
    const w = size;
    const h = size * 1.0;
    return (<Svg width={w} height={h} viewBox={`0 0 ${w} ${h}`}>
      {withGrid ? (<G opacity={0.12}>
          {Array.from({ length: 8 }).map((_, i) => (<Line key={`v${i}`} x1={(i + 1) * (w / 8)} y1={0} x2={(i + 1) * (w / 8)} y2={h} stroke={colors.cyanDim} strokeWidth={0.5}/>))}
          {Array.from({ length: 8 }).map((_, i) => (<Line key={`hg${i}`} x1={0} y1={(i + 1) * (h / 8)} x2={w} y2={(i + 1) * (h / 8)} stroke={colors.cyanDim} strokeWidth={0.5}/>))}
        </G>) : null}
      ...
      {/* chimney */}
      <Rect x={w * 0.65} y={h * 0.3} width={w * 0.05} height={h * 0.15} stroke={colors.text} strokeWidth={1.2} fill="none"/>
    </Svg>);
}
export function BlueprintPhoto({ size = 120 }) {
    return (<Svg width={size} height={size} viewBox="0 0 120 120">
      ...
      <G opacity={0.4}>
        {Array.from({ length: 10 }).map((_, i) => (<Line key={`bv${i}`} x1={(i + 1) * 12} y1={0} x2={(i + 1) * 12} y2={120} stroke={colors.cyanDim} strokeWidth={0.3}/>))}
        {Array.from({ length: 10 }).map((_, i) => (<Line key={`bh${i}`} x1={0} y1={(i + 1) * 12} x2={120} y2={(i + 1) * 12} stroke={colors.cyanDim} strokeWidth={0.3}/>))}
      </G>
...
export function PulseDot({ size = 10, color = '#6BCBD9' }) {
    return (<View style={{ width: size * 3, height: size * 3, alignItems: 'center', justifyContent: 'center' }}>
...
export function ToolsPhoto({ size = 120 }) {
...
export function HandshakePhoto({ size = 120 }) {
    return (<Svg width={size} height={size} viewBox="0 0 120 120">
      <Rect x={0} y={0} width={120} height={120} fill={colors.surface2}/>
...
export function ToolboxPhoto({ size = 120 }) {
    return (<Svg width={size} height={size} viewBox="0 0 120 120">
      <Rect x={0} y={0} width={120} height={120} fill={colors.surface2}/>
...
export function FridgePhoto({ size = 140 }) {
    return (<Svg width={size} height={size * 1.2} viewBox="0 0 140 168">
...
export function HouseCalmIllustration({ size = 140 }) {
    return (<Svg width={size} height={size * 0.85} viewBox="0 0 140 120">
      <G stroke={colors.text} strokeWidth={1.2} fill="none" strokeLinejoin="round">
...
export function WarmHouse({ size = 160 }) {
    return (<Svg width={size} height={size * 0.8} viewBox="0 0 160 128">
      <Defs>
...
export function BlueprintRoofScene({ size = 200 }) {
    return (<Svg width={size} height={size * 0.9} viewBox="0 0 200 180">
      <G opacity={0.25}>
        {Array.from({ length: 14 }).map((_, i) => (<Line key={`xv${i}`} x1={(i + 1) * (200 / 14)} y1={0} x2={(i + 1) * (200 / 14)} y2={180} stroke={colors.cyanDim} strokeWidth={0.4}/>))}
        {Array.from({ length: 12 }).map((_, i) => (<Line key={`xh${i}`} x1={0} y1={(i + 1) * (180 / 12)} x2={200} y2={(i + 1) * (180 / 12)} stroke={colors.cyanDim} strokeWidth={0.4}/>))}
      </G>
      <G stroke={colors.text} strokeWidth={1.2} fill="none" strokeLinejoin="round">
