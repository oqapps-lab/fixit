...
export const gradients = {
    ...
    bgAtmosphere: {
        colors: ['#0B0C0F', '#0A0A0B', '#08080A', '#0B0C0F'],
    ...
    glowAmber: {
        colors: ['rgba(255,169,92,0.14)', 'rgba(255,169,92,0.04)', 'rgba(0,0,0,0)'],
        locations: [0, 0.5, 1],
        start: { x: 0.5, y: 1 },
        end: { x: 0.5, y: 0.3 },
    },
    ...
    glowCyan: {
        colors: ['rgba(107,203,217,0.10)', 'rgba(107,203,217,0.03)', 'rgba(0,0,0,0)'],
        locations: [0, 0.5, 1],
        start: { x: 0.2, y: 0 },
        end: { x: 0.8, y: 0.5 },
    },
    ...
    cardTone: {
        colors: ['rgba(38,41,45,1)', 'rgba(22,23,25,1)'],
        start: { x: 0, y: 0 },
        end: { x: 0, y: 1 },
    },
    cardToneElevated: {
        colors: ['rgba(48,51,58,1)', 'rgba(29,31,34,1)'],
        start: { x: 0, y: 0 },
        end: { x: 0, y: 1 },
    },
    // CTA — clean 2-stop amber
    ctaAmber: {
        colors: ['#FFA95C', '#E8752A'],
        start: { x: 0, y: 0 },
        end: { x: 1, y: 1 },
    },
    // CTA filled — slightly richer but no streak
    ctaAmberRich: {
        colors: ['#FFC089', '#FFA95C', '#E8752A'],
        locations: [0, 0.5, 1],
        start: { x: 0, y: 0 },
        end: { x: 0, y: 1 },
    },
    // ring colors
    ringAmber: { colors: ['#FFA95C', '#E8752A'], start: { x: 0, y: 0 }, end: { x: 1, y: 1 } },
    ringCyan: { colors: ['#8EDDE9', '#6BCBD9'], start: { x: 0, y: 0 }, end: { x: 1, y: 1 } },
    ringMint: { colors: ['#9BEAB5', '#6BDE9A'], start: { x: 0, y: 0 }, end: { x: 1, y: 1 } },
};
export const radii = {
    xs: 6,
    sm: 10,
